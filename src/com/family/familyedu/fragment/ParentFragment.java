...
import com.family.familyedu.PositionDetailActivity;
import com.family.familyedu.PostPositionActivity;
import com.family.familyedu.R;
import com.family.familyedu.adapter.PostionAdapter;
 ...
 *
 */
public class ParentFragment extends BaseFragment implements OnItemClickListener {
	...
	private void initListView() {
		...
		// 再设置adapter
		adapter = new PostionAdapter(activity, positionList);
	...
	public void onClick(View v) {
		...
		case R.id.btnBaseRight:
			...
			Intent intent = new Intent(activity, PostPositionActivity.class);
			...
			public void onSuccess(JSONArray array) {
				...
				if (array != null && array.length() > 0) {
					...
					for (int i = 0; i < array.length(); i++) {
						...
						PositionBean bean = gson.fromJson(object.toString(),
								PositionBean.class);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
			long id) {
		PositionBean bean = positionList.get(position - 1);
