...
import com.test.woshifangnu.adapter.ChatAllHistoryAdapter;
import com.test.woshifangnu.db.InviteMessgeDao;
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (username
					...
					Toast.makeText(ChatHistoryActivity.this, st2, 0).show();
				else {
					// 进入聊天页面
					Intent intent = new Intent(ChatHistoryActivity.this,
							ChatActivity.class);
