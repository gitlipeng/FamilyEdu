...
import com.test.woshifangnu.adapter.ExpressionAdapter;
import com.test.woshifangnu.adapter.ExpressionPagerAdapter;
import com.test.woshifangnu.adapter.MessageAdapter;
import com.test.woshifangnu.adapter.VoicePlayClickListener;
import com.test.woshifangnu.util.CommonUtils;
import com.test.woshifangnu.util.DemoHXSDKHelper;
import com.test.woshifangnu.util.HXSDKHelper;
import com.test.woshifangnu.util.ImageUtils;
import com.test.woshifangnu.util.SmileUtils;
import com.test.woshifangnu.widget.ExpandGridView;
import com.test.woshifangnu.widget.PasteEditText;
				...
				try {
					...
					if (buttonSetModeKeyboard.getVisibility() != View.VISIBLE) {
						...
						if (filename != "delete_expression") { // 不是删除键，显示表情
							...
							Class clz = Class.forName(SmileUtils.class.getPackage().getName() + ".SmileUtils");
